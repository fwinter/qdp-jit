...
{
  typedef typename FurJedes<A , JIT2BASE , TreeCombine >::Type_t A_a;
  constexpr static bool value = is_same<typename Strip< typename FurJedes<A_a, EvalLeaf1, OpCombine>::Type_t >::Type_t , PSpinMatrix<float, 4> >::value;
};
