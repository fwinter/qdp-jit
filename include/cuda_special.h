...
void evaluate_special_prop_deriv_float ( int th_count, int N , int start, std::vector<void*> args , bool siteperm , int func_num );
void evaluate_special_prop_deriv_double( int th_count, int N , int start, std::vector<void*> args , bool siteperm , int func_num );
